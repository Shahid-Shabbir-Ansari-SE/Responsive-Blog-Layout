        ...
        <div className="flex  flex-col items-start justify-start xl:justify-center xl:space-x-8 xl:flex-row">
          <div className="flex justify-start items-center space-x-4">
            <div className="cursor-pointer w-12">
              <img className='rounded-full' src="https://pbs.twimg.com/profile_images/1686422540825276417/M2c_o25a_400x400.jpg" alt="logo" />
            </div>
            <p className="w-60 text-xl xl:text-2xl font-semibold leading-normal text-white">Shahid Shabbir</p>
          </div>
